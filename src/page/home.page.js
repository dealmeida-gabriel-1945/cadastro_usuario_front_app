    ...
    return (
        <>
            ...
            <View style={[FlexStyle.makeFlex(1), AlignStyle.centerX, PaddingStyle.makePadding(5, 10, 5, 10)]}>
                <Text style={[TextStyle.makeFontSize(15), MarginStyle.makeMargin(0, 0, 0, 10)]}>Feito por Gabriel
                    Guimarães de Almeida</Text>
                <Text style={[TextStyle.makeFontSize(13), TextStyle.textColor.azul]}
                      onPress={() => Linking.openURL('https://github.com/dealmeida-gabriel-1945/cadastro_usuario_front_app')}>
